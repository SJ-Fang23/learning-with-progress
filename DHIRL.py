...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_name", type = str, default="square")
    ...
    if args.env_name == "lift":
        robosuite_env_name = "SingleArmLift"  
...
################################################################    
    ...
    airl_trainer.train(2_000_000)  # Print actions and rewards during training
